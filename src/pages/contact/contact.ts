        ...
        loadingPop.dismiss(); 
                          if(resp.responseStatus.STATUS=='SUCCESS' && resp.responseStatus.STATUSCODE=='200' )
                          {
                           ...
                           // this.helperservice.sendalertmessage('bottom',resp.responseStatus.MESSAGE);
                            ...
                            if(this.hunterJsonResponse.data.first_name !=null && this.hunterJsonResponse.data.last_name !=null && this.hunterJsonResponse.data.email!=null  )
                            {
                              //'phone_number' :resp.data.phone_number.split('').join(' '),
                               this.hunter ={
                                 ...
                                 {
                                   //console.log('fff')
                                   this.hunter['phone_number']='+'+this.hunterJsonResponse.data.phone_number.split('').join(' ');
                                 }   
                                 else
                                 {
                           ...
                           else
                          {
                            ...
                            if(resp.responseData.jsonResponse.lushaJsonResponse!="")
                            {
                              ...
                              if(this.lushaJsonResponse.data.firstName !=null && this.lushaJsonResponse.data.lastName !=null && this.lushaJsonResponse.data.emailAddresses[0].email!=null)
                                {
                                  this.lusha ={
                                  ...
                                  if(this.lushaJsonResponse.data.company.name!=null) 
                                   ...
                                   {
                                     //console.log('fff')
                                     this.lusha['phone_number_two']=this.lushaJsonResponse.data.phoneNumbers[1].internationalNumber.split('').join(' ');
                                   }   
                                   else
                                   {
                                    //console.log('sddsdsfff')
